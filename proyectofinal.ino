...
void loop() {
 ...
 if (newFilteredMeasurements) {
    ...
    Serial.println(front);
      ...
      static const uint8_t MIN = 10;
      static const uint8_t MIN_SIDE_DIST = 10; // In cm
      static const uint8_t BACK_LEFT_DIST = 10;
      static const uint8_t MIN_BACK_LEFT_DIST = 10;
      static const uint8_t MIN_BACK_DIST = 10;
      static const uint8_t MIN_FRONT_DIST = 10;
